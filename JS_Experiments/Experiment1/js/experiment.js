function make_slides(f) {
  ...
  slides.block2 = slide({
    ...
    button : function() {
      if (exp.intelligencePost!= null && exp.assertivenessPost !=null && exp.empathyPost!=null && exp.femininityPost!=null && exp.democratPost!=null && exp.republicanPost!=null && exp.spBeliefPost!=null) {
        ...
        $("#speakerProfileImgProjective").attr("src", speakerProfileFilePath);
          ...
          if (this.stim.stimType == "critical"){
            ...
            utterance = this.stim.CC[0].toUpperCase()+this.stim.CC.substring(1) + "."
              ...
              if (  (this.stim.orientation == "conservative" & this.stim.socialInfo == "D") || (this.stim.orientation == "liberal" & this.stim.socialInfo == "R") ) {    
                    prefix = "It is true that "
                    true_false = "true"

              }
              else if ( (this.stim.orientation == "conservative" & this.stim.socialInfo == "R")|| (this.stim.orientation == "liberal" & this.stim.socialInfo == "D")  )  {
...
function getSpeaker(genderCounts,genderMaxes,i,type){
  ...
  //    console.log("odd stim",i)
    ...
    if (speakerPolitics == "D" & preferredSpeakerGender == "M"){
  ...
  else if (speakerPolitics == "D" & preferredSpeakerGender == "F"){
  ...
  else if (speakerPolitics == "R" & preferredSpeakerGender == "M"){
  ...
  else if (speakerPolitics == "R" & preferredSpeakerGender == "F"){
