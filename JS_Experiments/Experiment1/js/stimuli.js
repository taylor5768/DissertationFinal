...
//males - 4
"M-D-Daniel","M-D-Tim","M-D-John","M-D-James"])

femaleDemocrats =_.shuffle([
//females - 7
"F-D-Helen","F-D-Elizabeth","F-D-Lisa","F-D-Anna","F-D-Michelle",
])


maleRepublicans = _.shuffle([
//males - 6
"M-R-Joseph","M-R-Ryan","M-R-Anthony","M-R-Jason","M-R-Michael"
])
,

femaleRepublicans = _.shuffle([
"F-R-Sarah","F-R-Donna","F-R-Amy","F-R-Kimberly"])


additionalDemocratSpeakers = _.shuffle(["F-D-Veronica","F-D-Rachel"])
additionalRepublicanSpeakers = _.shuffle(["M-R-Eric","F-R-Lily"])

additionalSpeakers = _.shuffle(["F-D-Veronica","F-D-Rachel","M-R-Eric","F-R-Lily"])
...
//"objective":["capital","elections"],
//"MC":["taxes-L","lockdown-R"]

  "additionalStims":{
    "O":["capital","elections"],
    "MC":["taxes-L","lockdown-L"],
...
speakerPoliticsOrder = _.shuffle(["D","R"])
