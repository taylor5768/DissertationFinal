...
var _stream = function() {
  ...
  if (this.present == undefined) {
    ...
    if (presented_stims.length === 0) {
      ...
      /*if (repeatTwice == true){
      exp.structure[3]  //navigate to the second part of social eval block
      exp.phase[i+1]  //navigate to the next slide 
      }*/

      exp.phase++;

      //THIS IS WHERE WE NEED TO SAY - DON"T SHIFT YET - USE SAME STIM TWO TIMES SOMEHOW
