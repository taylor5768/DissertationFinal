...
d.ItIsTF.welfare <-cd %>% 
  filter((true_false == "TRUE" | true_false == "FALSE") & (block3 == "block3") & (topic=="welfare"))%>%
  droplevels()

xtabs(~true_false+socialInfo+orientation,data=d.ItIsTF.welfare)

d.ItIsTF.environment <-cd %>% 
  filter((true_false == "TRUE" | true_false == "FALSE") & (block3 == "block3") & (topic=="environment"))%>%
  droplevels()

xtabs(~true_false+socialInfo+orientation,data=d.ItIsTF.environment)

d.ItIsTF.list1D.environment <-cd %>% 
  filter(list_whichSpPoliticsFirst == "list1_D" & (true_false == "TRUE" | true_false == "FALSE") & (block3 == "block3") & (topic=="environment"))%>%
  droplevels()

xtabs(~true_false+socialInfo+orientation,data=d.ItIsTF.list1D.environment)


d.ItIsTF.list1D.welfare <-cd %>% 
  filter(list_whichSpPoliticsFirst == "list1_D" & (true_false == "TRUE" | true_false == "FALSE") & (block3 == "block3") & (topic=="welfare"))%>%
  droplevels()

xtabs(~true_false+socialInfo+orientation,data=d.ItIsTF.list1D.welfare)
