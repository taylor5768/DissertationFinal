...
## 1A. projection#
##################
certaintyRatingDist <- ggplot(subset(cd,item_type=="critical" & projection!="NA"), aes(x=projection)) +
...
political.1<-lmer(projection~ (socialInfo +  orientation + predicate)^2+ (1|topic) + (1+socialInfo|workerid),
